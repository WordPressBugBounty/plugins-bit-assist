<?php
namespace BitApps\Assist\Deps\BitApps\WPValidator;

use BitApps\Assist\Deps\BitApps\WPValidator\Exception\MethodNotFoundException;
use BitApps\Assist\Deps\BitApps\WPValidator\Exception\RuleErrorException;
